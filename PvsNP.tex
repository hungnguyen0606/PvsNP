...
\begin{document}
	...
	\section{Định nghĩa}
		\subsection{Turing machine}
			...
			\subsubsection{Deterministic Turing machine}
				...
				\begin{tabular}{l p{4in}}
					...
					$F\subseteq Q$& là tập trạng thái kết thúc hoặc chấp nhật (accepting states). Nội dung 1 tape được xem là chấp nhận bởi turing machine M khi và chỉ khi nó kết thúc với một trạng thái thuộc F.
				\end{tabular}  
		...
		\subsection{Lớp bài toán P}
			Lớp P bao gồm tất cả các bài toán mà tồn tại một thuật toán có thể đưa ra lời giải của nó trong thời gian đa thức.\\
